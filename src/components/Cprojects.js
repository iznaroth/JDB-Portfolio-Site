...
import { cprojects } from "../data";

export default function Cprojects() {
  return (
    <section id="cprojects" className="text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            A highlight reel of my nastiest class projects. Hover over them for more details.
          </p>
        </div>
